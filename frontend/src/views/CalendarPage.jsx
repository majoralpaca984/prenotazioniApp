    ...
    <div className="space-y-6">
      ...
      {stats.total > 0 && (
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          ...
          <div className="rounded-lg border border-gray-200 bg-white p-4 text-center">
            ...
            <div className="text-sm text-gray-600">Programmati</div>
          </div>
          <div className="rounded-lg border border-gray-200 bg-white p-4 text-center">
          ...
          <div className="rounded-lg border border-gray-200 bg-white p-4 text-center">
            ...
            <div className="text-sm text-gray-600">Annullati</div>
          </div>
        </div>
      )}
      ...
      <div className="flex items-center justify-between rounded-xl border border-gray-200 bg-white p-4 shadow-sm">
        <button
          ...
          className="flex items-center gap-2 px-4 py-2 text-gray-600 transition-colors hover:text-primary-500"
        >
          <i className="fas fa-chevron-left"></i>
          <span className="hidden sm:inline">Mese Precedente</span>
        </button>

        <h2 className="text-center text-xl font-semibold capitalize text-gray-900 md:text-2xl">
          {monthName}
        </h2>
            ...
            <div className="space-y-3 max-h-96 overflow-y-auto">
              {currentMonthAppointments
                ...
                .map((appointment) => (
                  <div 
                    key={appointment._id}
                    className="flex items-center justify-between rounded-lg border border-gray-200 p-4 transition-colors hover:border-primary-300"
                  >
      ...
      {currentMonthAppointments.length === 0 && !loading && (
        <div className="text-center py-12">
          <div className="max-w-md mx-auto">
            <i className="fas fa-calendar-plus mb-4 text-6xl text-gray-300"></i>
